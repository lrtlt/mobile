  ...
  const onPressHandler = useCallback(() => {
    try {
      if (props.record_article_id) {
        ...
        if (props.is_radio) {
          navigation.replace('Podcast', {articleId});
        } else {
          navigation.replace('Vodcast', {articleId});
        }
      ...
      <View style={styles.content}>
        ...
        <View style={styles.textContainer}>
          <View style={{flexDirection: 'row', alignItems: 'center', gap: 8}}>
            ...
            <TextComponent style={styles.titleText} type={props.record_article_id ? 'primary' : 'secondary'}>
              {props.title}
            </TextComponent>
          </View>
